...
# i dont know how or why but for some fucking reason if you merge the audio tracks on a video then run this script it looks for -1.log instead of -0.

cp ffmpeg2pass-0.log ffmpeg2pass-1.log
cp ffmpeg2pass-0.log.mbtree ffmpeg2pass-1.log.mbtree 
...
rm ffmpeg2pass-1.log
rm ffmpeg2pass-0.log.mbtree
rm ffmpeg2pass-1.log.mbtree
